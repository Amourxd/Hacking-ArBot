...
from hackingarbot import hn, BotClient, HEROKU_APP_NAME, HEROKU_API_KEY, SUDO_USERS, DEV_USERS
...
async def dyno_usage(dyno):
    ...
    args = [sys.executable, "-m", "hackingarbot"]
